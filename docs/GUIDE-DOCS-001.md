...
| **주제약어**      | 문서가 다루는 핵심 주제를 나타내는 약어. 아래 '4. 주제약어 정의' 참조. | `DOCS`      |
| **일련번호**      | 동일 분류 및 주제 내에서 순차적으로 부여되는 3자리 번호.               | `001`      |

**완성된 ID 예시:** `GUIDE-SYS-001`

> (의미: 프로젝트의 가이드 문서이며, 시스템 전반을 주제로 한, 첫 번째 문서)
...
| **US**    | 유저 스토리 명세서        | 사용자 관점의 요구사항과 인수 조건을 상세히 기술한 문서                                    |
...
| **ADR**  | 기술 의사결정 명세서          | 주요 기술적 의사결정 사항과 그 배경, 대안 분석, 최종 결론을 기록한 문서                  |
...
| **API**  | API 문서                    | 시스템 내/외부 API의 엔드포인트, 요청/응답 규격, 파라미터 등을 정의한 문서         |
...
`주제약어`는 AssetMind 프로젝트의 주요 구성요소 및 기술 스택을 기준으로 정의한다.

| 주제약어 | 주제 (Topic)              | 설명                                                         |
| :------- | :------------------------ | :----------------------------------------------------------- |
| **SYS**  | 시스템 전반 (System)      | 프로젝트 전체에 해당하는 내용 (예: 프로젝트 계획서, 본 문서) |
| **DOCS** | 일반 문서 | 프로젝트 수행과 관련된 일반벅인 문서, 참고 자료 및 매뉴얼 등을 정의한 문서 |
